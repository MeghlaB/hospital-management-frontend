...
export default function DoctorSearchSection() {
  ...
  return (
    <div className="bg-teal-700 text-white p-6 rounded-md w-full max-w-5xl mx-auto shadow-md">
      <div className="flex flex-col lg:flex-row items-start lg:items-center gap-4">
        <div className="flex-1 w-full">
          ...
          <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
            <div className="relative w-full sm:w-1/3">
              ...
              <div className="bg-teal-700 border-b border-white flex items-center justify-between px-2 py-1">
                <input
                  type="text"
            ...
            <div className="w-full sm:w-2/3">
              ...
              <input
                ...
                className="bg-teal-700 border-b border-white text-white placeholder-white w-full px-2 py-1 outline-none"
                value={searchText}
                onChange={(e) => {
        ...
        <div className="flex gap-2">
          <button
            ...
            className="bg-teal-800 px-4 py-2 rounded hover:bg-teal-700 transition"
          >
